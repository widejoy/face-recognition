...
for j in range(len(image_2_loc)):
 encoding_image_1 = face_recognition.face_encodings(image_1)[j]
 for i in range(len(image_1_loc)):
...
root.mainloop()
top_1 = image_1_loc[i][0]
right_1 = image_1_loc[i][1]
bottom_1 = image_1_loc[i][2]
left_1 = image_1_loc[i][3]
top = image_1_loc[j][0]
...
draw.rectangle((left_1,top_1,right_1,bottom_1),outline=(250,7,0))
draw_1 = ImageDraw.Draw(image_2_pil)
draw_1.rectangle((left,top,right,bottom),outline=(250,7,0))
image_1_pil.show()
image_2_pil.show()
